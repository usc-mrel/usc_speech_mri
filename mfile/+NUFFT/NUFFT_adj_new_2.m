function image = NUFFT_adj_new_2(kSpace_non_cart, N)
%--------------------------------------------------------------------------
%   [image] = NUFFT_adj_new_2(kSpace_non_cart,N)
%--------------------------------------------------------------------------
...
%filter
kSpace_cart = NUFFT.rad2cart_new(kSpace_non_cart,N);
